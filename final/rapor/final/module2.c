...
int main(int argc, char const *argv[])
{
    ...
    printf("NUMBER OF MULTIPLIED MATRICES %d\n", multiply_index);
...
void multiplier(void* arg){
    ...
    while(!die_flag){
        ...
        if(DEBUG)
            printf("Worker Thread: %u in critical section \n", (unsigned int) pthread_self());
...
void rs_module1(void* arg){
    ...
    while(!die_flag){
        ...
        if(size > 0){
            ...
            if(DEBUG){
                printf("\n-----------------------------------\n");
                printf("received U from Module1\n");
                for(i = 0; i < size; ++i){
                    for (j = 0; j < size; ++j){
                ...
                printf("received L from Module1\n");
                for(i = 0; i < size; ++i){
                    for (j = 0; j < size; ++j){
    ...
    while(!die_flag){
        ...
        */
        ...
        if(size > 0){
            ...
            if(DEBUG)
                printf("\nBoss Thread: %u in critical section in producer module\n", (unsigned int) pthread_self());

            printf("\n-----------------------------------\n");
            printf("------Reveived U from Verifier module ----\n");
            for(i = 0; i < size; ++i){
                for (j = 0; j < size; ++j){
                    printf("%6.6f ", first_buf[i][j]);
                }
            ...
            printf("\n------Reveived L from Verifier module ----\n");
            for(i = 0; i < size; ++i){
                for (j = 0; j < size; ++j){
                    printf("%6.6f ", sec_buf[i][j]);
                }
...
void print_usage(){
    puts("Usage: ./module2 <[L] QUEUE_SIZE> <[P] NUM_OF_THREAD> <DEBUG>");
    puts("Example: ./module1 100 3 1");
}